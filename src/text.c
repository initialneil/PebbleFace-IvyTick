...
static GFont s_time_font, s_month_font, s_date_font, s_weekday_font;
...
void init_date_layer(Window *window) {
  ...
  s_month_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_DIGITAL_16));
  s_date_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_DIGITAL_16));
  s_weekday_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_DIGITAL_16));

  // Create month TextLayer
  s_month_layer = text_layer_create(GRect(s_win_w - 38, 0, 50, 25));
  ...
  s_date_layer = text_layer_create(GRect(s_win_w - 12, 0, 50, 25));
